...
public class SeparateChainingHashTable<AnyType>
{
    ...
    public int itemsize(String[] parts)
    {
        //Complete the itemsize() to return the number of items stored int the hashtable
        SeparateChainingHashTable hm = new SeparateChainingHashTable();
        Integer count = (Integer) hm.get(parts).value;
    ...
    {
        File file = new File("C:/Users/tmari/Desktop/AccessLog.txt");// Replace path_to_AccessLog.txt by the path of AccessLog.txt on your computer, i.e., if you place the AccessLog.txt on the desktop of Windows, most likely, the path would be "C:/Users/Bowu/Desktop/AccessLog.txt"
        ...
        while (sc.hasNextLine()) //Read access log line by line
        {
            ...
            for (int i = 0; i < parts.length; i++)
            {
                ...
                if (hm.get(parts) == null)
                {
                    System.out.println("HM cannot be found");
                } else {
                    Integer count = (Integer) hm.get(p).value;

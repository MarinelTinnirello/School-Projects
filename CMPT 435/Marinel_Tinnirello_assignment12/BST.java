...
public class BST  implements Iterable
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("The 2nd smallest node is " + ReturnKthSmallestElement(2, bst.root));
        // the output should be 2

    }

    public static int ReturnKthSmallestElement(int k, Node p)
    {
        ...
        while (current != null)
        {
            /** if current is null, increment, check and set data
             * else if, create and build links
             **/
            if (current.left == null)
            {
                count++;

                /** if count is k, set kSmall to current data **/
                if (count == k)
                {
                    kSmall = current.data;
                }
            ...
            } else
            {
                ...
                /*** loop while prev right is not null and prev right is not current ***/
                while ((prev.right != null) && (prev.right != current))
                {
                    prev = prev.right;
                }

                /** if prev right is null, set prev right to current and current to left
                 * else if, set prev right to null and increment
                 **/
                if (prev.right == null)
                {
                    prev.right = current;
                ...
                }  else
                {
                    ...
                    /** if count is k, set kSmall to current right **/
                    if (count == k)
                    {
                        kSmall = current.data;
                    }
